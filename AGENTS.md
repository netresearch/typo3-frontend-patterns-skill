...
Reusable frontend implementation patterns for TYPO3 v13/v14 LTS sitepackage development, distributed as a Claude Code skill. Patterns include Fluid templates, TypeScript plugins, SCSS partials, and accessibility considerations.

## Repo Structure

```
typo3-frontend-patterns-skill/
├── skills/typo3-frontend-patterns/   # Skill definition and references
...
- Skill behavior is defined by [skills/typo3-frontend-patterns/SKILL.md](skills/typo3-frontend-patterns/SKILL.md) — its `description` field must begin with `Use when` to activate correctly in Claude Code.
...
- Patterns documented in this skill must stay theme-agnostic — they complement, but do not replace, Camino, bootstrap-package, or custom sitepackage themes.
- Fluid 5 (TYPO3 v14) enforces strict ViewHelper typing: pattern templates targeting v14 must use typed arguments and `render(): string`.
...
- [skills/typo3-frontend-patterns/SKILL.md](skills/typo3-frontend-patterns/SKILL.md) — skill content and triggers
- `netresearch/skill-repo-skill` (external) — source of truth for reusable CI workflows and structural conventions
- `netresearch/typo3-vite-skill` (external) — mandatory frontend build tool for TYPO3 v14 (Breaking [#108055](https://docs.typo3.org/c/typo3/cms-core/main/en-us/Changelog/14.0/Breaking-108055-RemovedFrontendAssetConcatenationAndCompression.html))
